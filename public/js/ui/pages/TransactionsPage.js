...
class TransactionsPage {
  ...
  removeAccount() {
    if (this.lastOptions) {
      let resultConfirm = confirm(`Вы действительно хотите удалить счет "${this.currentAccName}"?`);
      if (resultConfirm) {
        let accData = {id : this.lastOptions.account_id};
  ...
  removeTransaction( id ) {
    let resultConfirm = confirm(`Вы действительно хотите удалить эту транзакцию?`);
    if (resultConfirm) {
      let transactionData = {id};
